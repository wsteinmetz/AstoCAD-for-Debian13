...
const App::PropertyIntegerConstraint::Constraints Part::LinearPatternExtension::intOccurrences
...
gp_Vec Part::LinearPatternExtension::calculateOffsetVector(LinearPatternDirection dir) const
{
...
gp_Dir Part::LinearPatternExtension::getDirectionFromProperty(const App::PropertyLinkSub& dirProp) const
{
