...
const App::PropertyIntegerConstraint::Constraints Part::PolarPatternExtension::intOccurrences
    = {1, std::numeric_limits<int>::max(), 1};

const char* Part::PolarPatternExtension::ModeEnums[] = {"Extent", "Spacing", nullptr};

Part::PolarPatternExtension::PolarPatternExtension()
{
...
const std::list<gp_Trsf> Part::PolarPatternExtension::calculateTransformations() const
{
...
gp_Ax2 Part::PolarPatternExtension::getRotation() const
{
...
void Part::PolarPatternExtension::setReadWriteStatusForMode(PolarPatternMode mode)
{
    Offset.setReadOnly(mode != PolarPatternMode::Spacing);
    Angle.setReadOnly(mode != PolarPatternMode::Extent);
}

void Part::PolarPatternExtension::updateSpacings()
{
...
short Part::PolarPatternExtension::extensionMustExecute()
{
...
void Part::PolarPatternExtension::extensionOnChanged(const App::Property* prop)
{
